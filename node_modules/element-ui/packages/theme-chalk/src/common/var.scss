...
$--border-color-base: $--select-border-color !default;
/// color|1|Border Color|3
...
$--select-input-color: $--color-primary !default;
...
$--select-dropdown-background: $--table-tr !default;
$--select-dropdown-shadow: #131a2d !default;
$--select-dropdown-empty-color: #999 !default;
/// height||Other|4
$--select-dropdown-max-height: 274px !default;
$--select-dropdown-padding: 6px 0 !default;
$--select-dropdown-empty-padding: 10px 0 !default;
$--select-dropdown-border: solid 1px $--select-border-color !default;
