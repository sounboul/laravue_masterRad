export default {
  ...
  login: {
    ...
    password: 'Lozinka',
    any: 'bilo koji',
    thirdparty: 'Ili se povešite preko',
  ...
  permission: {
    addRole: 'Novo zaduženje',
    editPermission: 'Uredi dozvolu',
    roles: 'Vaše zaduženje',
    switchRoles: 'Zamena zaduženja',
    tips: 'U nekim slučajevima nije prikladno koristiti v-role / v-dozvolu, kao što je komponenta Tab elementa ili el-table-column i drugi slučajevi asinhronog prikazivanja dom, što se može postići samo ručnim podešavanjem v-if pomoću checkRole ili / i checkPermission.',
    delete: 'Obriši',
    confirm: 'Potvrdi',
    cancel: 'Otkaži',
  },
  ...
  roles: {
    description: {
      ...
      user: 'Normal user. Ima pristup nekim stranicama',
