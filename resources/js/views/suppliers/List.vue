<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('user.address')" align="left" width="350px">
        <template slot-scope="{row}">
...
<script>
import { fetchPv, showSupplier, createSupplier, updateSupplier, deleteSupplier, fetchSuppliers } from '@/api/supplier';
...
export default {
  ...
  methods: {
    async getList() {
      ...
      const { data } = await fetchSuppliers(this.listQuery);
